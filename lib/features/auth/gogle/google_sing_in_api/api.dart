...
final class GoogleSignInApi {
  static final GoogleSignInApi _singleton = GoogleSignInApi._internal();
  GoogleSignInApi._internal();
  static GoogleSignInApi get instance => _singleton;
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        ToastUtil.showShortToast(
          data.message ?? "Logged in with Google successfully.",
          forceShow: true,
        );
        return data;
      } else {
