...
final class PrivacyPolicyRx extends RxResponseInt<PrivacyPolicyModel> {
  ...
  ValueStream<PrivacyPolicyModel> get getPrivacyPolicyData => dataFetcher.stream;

  Future<void> getPrivacyPolicy() async {
    isLoading.value = true;
    try {
      final data = await api.getPrivacyPolicyApi();
  ...
  handleErrorWithReturn(dynamic error) {
    ...
    ToastUtil.showShortToast("Failed to load privacy policy. Please try again.");
    dataFetcher.sink.addError(error);
    return false;
  }
}
