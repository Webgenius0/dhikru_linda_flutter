...
class _TermsAndConditionScreenState extends State<TermsAndConditionScreen> {
  ...
  void initState() {
    ...
    termsAndConditionRxObj.getTermsAndCondition();
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ── Content body ──
            Expanded(
              child: StreamBuilder<TermsAndConditionModel>(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          StreamBuilder<TermsAndConditionModel>(
            stream: termsAndConditionRxObj.getTermsAndConditionData,
            builder: (context, snapshot) {
              final title = snapshot.data?.data?.title ?? 'Terms & Conditions';
              return Text(
                title,
